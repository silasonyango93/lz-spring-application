...
public class LzQuestionnaireSessionDao implements LzQuestionnaireSessionRepository {
    ...
    @Override
    public List<LzQuestionnaireSessionEntity> findByCountyId(int countyId) {
        return null;
    }

    @Override
    public LzQuestionnaireSessionEntity findByLzQuestionnaireSessionId(int lzQuestionnaireSessionId) {
        return null;
    }
