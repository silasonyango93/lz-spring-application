...
@Table(name = "lz_calving")
public class LzCalvingEntity implements java.io.Serializable {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "LzCalvingId")
    private int lzCalvingId;
    ...
    public LzCalvingEntity() {
    }

    public LzCalvingEntity(int lzQuestionnaireSessionId, int scaleMetricId, int monthId) {
        this.lzQuestionnaireSessionId = lzQuestionnaireSessionId;
        this.scaleMetricId = scaleMetricId;
        this.monthId = monthId;
    }

    public int getLzCalvingId() {
        return lzCalvingId;
    }

    public void setLzCalvingId(int lzCalvingId) {
        this.lzCalvingId = lzCalvingId;
    }
