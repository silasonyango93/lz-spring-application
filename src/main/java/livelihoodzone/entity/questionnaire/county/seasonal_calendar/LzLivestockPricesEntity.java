...
@Table(name = "lz_livestock_prices")
public class LzLivestockPricesEntity implements java.io.Serializable {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "LzLivestockPriceId")
    private int lzLivestockPriceId;
    ...
    public LzLivestockPricesEntity() {
    }

    public LzLivestockPricesEntity(int lzQuestionnaireSessionId, int scaleMetricId, int monthId) {
        this.lzQuestionnaireSessionId = lzQuestionnaireSessionId;
        this.scaleMetricId = scaleMetricId;
        this.monthId = monthId;
    }

    public int getLzLivestockPriceId() {
        return lzLivestockPriceId;
    }

    public void setLzLivestockPriceId(int lzLivestockPriceId) {
        this.lzLivestockPriceId = lzLivestockPriceId;
    }
