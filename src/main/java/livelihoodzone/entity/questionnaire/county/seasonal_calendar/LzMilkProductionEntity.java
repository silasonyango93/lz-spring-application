...
@Table(name = "lz_milk_production")
public class LzMilkProductionEntity implements java.io.Serializable {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "LzMilkProductionId")
    private int lzMilkProductionId;
    ...
    public LzMilkProductionEntity() {
    }

    public LzMilkProductionEntity(int lzQuestionnaireSessionId, int scaleMetricId, int monthId) {
        this.lzQuestionnaireSessionId = lzQuestionnaireSessionId;
        this.scaleMetricId = scaleMetricId;
        this.monthId = monthId;
    }

    public int getLzMilkProductionId() {
        return lzMilkProductionId;
    }

    public void setLzMilkProductionId(int lzMilkProductionId) {
        this.lzMilkProductionId = lzMilkProductionId;
    }
