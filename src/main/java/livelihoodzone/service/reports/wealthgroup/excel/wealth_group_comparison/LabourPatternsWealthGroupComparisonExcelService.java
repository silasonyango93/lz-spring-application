...
@Service
public class LabourPatternsWealthGroupComparisonExcelService {
    ...
    public XSSFWorkbook processData(int countyId,int livelihoodZoneId, XSSFWorkbook workbook, String sectionName) {
        ...
        List<WgLivelihoodZoneDataObject> wgLivelihoodZoneDataObjectList = wealthGroupChartsService.prepareWealthGroupChartByLivelihoodZone(countyId,livelihoodZoneId,5);
