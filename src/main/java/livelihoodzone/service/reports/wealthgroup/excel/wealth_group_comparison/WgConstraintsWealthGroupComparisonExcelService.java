...
@Service
public class WgConstraintsWealthGroupComparisonExcelService {
    ...
    public XSSFWorkbook processData(int countyId,int livelihoodZoneId, XSSFWorkbook workbook, String sectionName) {
        ...
        List<WgLivelihoodZoneDataObject> wgLivelihoodZoneDataObjectList = wealthGroupChartsService.prepareWealthGroupChartByLivelihoodZone(countyId,livelihoodZoneId,8);
