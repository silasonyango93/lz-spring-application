...
@Service
public class MainSourcesOfFoodAndIncomeWealthGroupComparisonExcelService {
    ...
    public XSSFWorkbook processData(int countyId,int livelihoodZoneId, XSSFWorkbook workbook, String sectionName) {
        ...
        List<WgLivelihoodZoneDataObject> wgLivelihoodZoneDataObjectList = wealthGroupChartsService.prepareWealthGroupChartByLivelihoodZone(countyId,livelihoodZoneId,1);
